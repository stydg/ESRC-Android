...
public class MainActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private static final String APP_ID = "E395103A-829B-3A9C-8231-9319312156AC";  // Application ID.

    // Permission
    private static final int PERMISSIONS_REQUEST_CODE = 1000;
    private static final String[] PERMISSIONS = {INTERNET, CAMERA, READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE};
    private static final int[] countEmotion = {0, 0, 0, 0, 0, 0, 0};
    ...
    public int emotion1, emotion2, emotion3 = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TimerTask goGeo = new TimerTask(){
            public void run(){
                Log.v("emotion number", "화남: " + String.valueOf(countEmotion[0]) + ", 경멸 : " +
                        String.valueOf(countEmotion[1]) + ", 공포 : " + String.valueOf(countEmotion[2]) +
                        ", 행복 : " + String.valueOf(countEmotion[3]) + ", 슬픔 : " + String.valueOf(countEmotion[4]) +
                        ", 놀람 : " + String.valueOf(countEmotion[5]) + ", 정상 : " + String.valueOf(countEmotion[6]));
        ...
        ESRC.start(mProperty, new ESRC.ESRCHandler() {
            ...
            public void onRecognizedBasicFacialExpression(ESRCType.BasicFacialExpression basicFacialExpression, ESRCException e) {
                if (e == null) {
                    ...
                    if (emotion != null) {
                        ...
                        String numStr2 = String.valueOf(emotion.ordinal());
                        int numInt = Integer.parseInt(numStr2);
                        countEmotion[numInt] = countEmotion[numInt] + 1;
                        //Log.v("emotion number", numStr2);
                    }
            ...
            public void onRecognizedEngagement(ESRCType.Engagement engagement, ESRCException e) {
                if (e == null) {
                    ...
                    String numStr3 = String.valueOf(engagement.getEmotionStr());
                    Log.v("emotion number", numStr3);
